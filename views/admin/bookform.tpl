...
<div class="card expandable">
	<div class="card-header">{l s='Book Form' mod='clariprint'} <input type="text" class="ProductName" name="{$product_key}[name]" value="{$product->name}" placeholder="{l s='nom du produit' mod='clariprint'}" /><span class="remove_product ui-button-icon ui-icon ui-icon-closethick" style="float: right"></span></div>
	<div class="product_accordion clariprint_product card-block clariprint_formbook" productkey="{$product_key}">
		...
		<div class="bookcover cl_accordion">
			<h3 class="accordion_header">{l s='Options' mod='clariprint'}</h3>
			<div class="bookcoveroption">
				<label>{l s='No cover' mod='clariprint'}</label>
				<div class="margin-form">
					<input type="radio" name="{$product_key}[options][cover]" value=""><br/>
				</div>
				<label>{l s='Cover is optional' mod='clariprint'}</label>
				<div class="margin-form">
				<input type="radio" name="{$product_key}[options][cover]" value="opt"/><br/>
				</div>
				<label>{l s='With Cover' mod='clariprint'}</label>
				<div class="margin-form">
				<input type="radio" name="{$product_key}[options][cover]" value="1"><br/>
				</div>
			</div>
				...
				{assign var=product value=(object)$product->cover}
		...
		<h3 class="accordion_header">{l s='Back cover' mod='clariprint'}</h3>
		<div class="backcover cl_accordion">
			<h3 class="accordion_header">{l s='Options' mod='clariprint'}</h3>
			<div class="backcoveroption">
				<label>{l s='No back' mod='clariprint'}</label>
				<div class="margin-form">
					<input type="radio" name="{$product_key}[options][backcover]" value=""><br/>
				</div>
				<label>{l s='Back is optional' mod='clariprint'}</label>
				<div class="margin-form">
				<input type="radio" name="{$product_key}[options][backcover]" value="opt"/><br/>
				</div>
				<label>{l s='With Cover' mod='clariprint'}</label>
				<div class="margin-form">
				<input type="radio" name="{$product_key}[options][backcover]" value="1"><br/>
				</div>
			</div>
				{assign var=main_product_key value=$product_key}
				{assign var=product_key value="$main_product_key[backcover]"}
				{assign var=main_product value=$product}
				{assign var=product value=(object)$product->cover}
				{include file='./cover.tpl'}
				{assign var=product_key value=$main_product_key}
