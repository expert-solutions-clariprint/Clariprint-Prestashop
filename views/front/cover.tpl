...
*  @license    proprietary
*}
<div class="card bookcover expandable clariprint-cover">
<h3 class="accordion_header card-header">{l s='Cover' mod='clariprint'} </h3>
<div class="cover cl_accordions card-block">
	<input type="hidden" value="cover" name="{$product_key}[kind]">
	{include file='./dimensions.tpl'}
	{include file='./coverdie.tpl'}
